...
public class CaseController {
    ...
    public List<CaseService.CaseSummary> queue(
        ...
        return cases.queue(normalize(status), normalize(category),
                normalizeAssignedTo(assignedTo));
    }
    ...
    public CaseService.FeedbackView feedback(@PathVariable UUID exceptionId,
        ...
        return cases.recordFeedback(exceptionId, safe.get("analystId"),
                safe.get("originalValue"), safe.get("correctedValue"),
                safe.get("reason"));
    }
    ...
    private static String normalizeAssignedTo(String value) {
